...
export const SitesScreen: FC<SitesScreenProps> = observer(function SitesScreen(_props) {
  ...
  const SiteItem = ({ item }) => (
    <>
      ...
      <Button
        ...
        style={[
          $siteButton,
          siteStore.siteSelected(item) && { backgroundColor: colors.palette.primary100 },
        ]}
      >
        <Text
  ...
  return (
    ...
    >
      <View>
        <Text testID="login-heading" tx={"sitesScreen.connectedTo"} preset="formLabel" />
        <View style={$connectedButtonsView}>
          <Button
            testID="login-button"
            tx={"sitesScreen.receptionist"}
      ...
      <View style={{ marginTop: spacing.md }}>
        <Text testID="login-heading" tx={"sitesScreen.siteSelection"} preset="formLabel" />
        <View style={$connectedButtonsView}>
          <DropDownPicker
            schema={{
              label: "SiteName",
      ...
      <View style={$toggleViewStyle}>
        <Text testID="login-heading" tx={"sitesScreen.appMode"} preset="formLabel" />
        <View style={{ width: "40%" }}>
          <Toggle
