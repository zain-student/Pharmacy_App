const en = {
  ...
  landingScreen: {
    ...
    welcomeText:
      "Elevate patients’ check-in and invoice making experience with digital receptionist",
    signIn: "SIGN IN",
  ...
  medicationsHistoryScreen: {
    medicationsHistoryScreen: "Medications History",
    addNewMedications: "Dispatch Medication",
  },

  addNewMedicationsScreen: {
    addNewMedications: "Dispatch Medication",
  },
