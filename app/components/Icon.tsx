...
export const iconRegistry = {
  ...
  checkin_blue: require("../../assets/icons/checkin_blue.png"),
  ...
  prescription_blue: require("../../assets/icons/prescription_blue.png"),
  pharmacy: require("../../assets/icons/pharmacy.png"),
  pharmacy_blue: require("../../assets/icons/pharmacy_blue.png"),
